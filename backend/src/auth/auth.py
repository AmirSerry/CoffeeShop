...
AUTH0_DOMAIN = 'dev-zjbn2q87.au.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'dev'
CLIENT_ID = 'eMkA3Zme3PrOjpr0VcTLi43WOkMdoPm4'
...
@TODO implement verify_decode_jwt(token) method
    ...
    https://stackoverflow.com/questions/50236117/scraping-ssl-certificate-verify-failed
    -error-for-http-en-wikipedia-org
'''


def verify_decode_jwt(token):
    jsonurl = requests.get('https://dev-zjbn2q87.au.auth0.com/.well-known/jwks.json')
    jwks = jsonurl.json()
